...
```sh
  eslint-config-prettier            dev     ~2mo     7.1.0  →     8.0.0   ~3d
  @fewlines/eslint-config           dev     ~7mo     3.0.0  →     3.1.2   ~1d
  @typescript-eslint/eslint-plugin  dev     ~2mo    4.11.0  →    4.15.2   ~2d
  @typescript-eslint/parser         dev     ~2mo    4.11.0  →    4.15.2   ~2d
  eslint                            dev     ~2mo    7.16.0  →    7.20.0  ~12d
  ts-jest                           dev     ~4mo    26.4.4  →    26.5.2   ⩽1d
  typescript                        dev     ~2mo     4.1.3  →     4.2.2   ⩽1d
  @types/jest                       dev     ~3mo   26.0.19  →   26.0.20  ~2mo
  @types/node                       dev     ~2mo  14.14.14  →  14.14.31   ~5d
